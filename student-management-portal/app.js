...
app.get('/profile/:index', (req, res) => {
    ...
    let marksTableHTML = '<table><tr><th>Subject</th><th>CAT1</th><th>CAT2</th><th>FAT</th><th>GRADE</th></tr>';
    for (const subject in user.marks) {
        marksTableHTML += `
            <tr>
                ...
                <td>${user.marks[subject].GRADE}</td>
            </tr>
        `;
    }
    ...
    const studentProfileHTML = `
        ...
        <body>
            ...
            ${marksTableHTML}<br>
            <p style="text-align:center;font-size:20px;font-weight:bold;">CGPA: ${user.cgpa}</p>
        </body>
        </html>
    `;
